...
datos = pd.read_csv('C://Users//Sony//Desktop//TESIS 2//PRUEBA DE CONCEPTO//Hoja.csv')
...
model=  OneVsRestClassifier(GaussianNB(priors=None, var_smoothing=1e-10))
...
print("PRECISIÓN PARA DETECTAR A LA BOTNET ", metrics.precision_score(y_test, y_pred, average=None))

print("RECALL PARA DETECTAR A LA BOTNET: ", metrics.recall_score(y_test, y_pred, average=None))

print("PRECISIÓN PARA DETECTAR A UN BENIGNO ", metrics.precision_score(y_test, y_pred , average=None))

print("RECALL PARA DETECTAR A LA BENIGNO: ", metrics.recall_score(y_test, y_pred, average=None))
