...
df = pd.read_csv('CIC-AWS-2018.csv')
df.head(10)
...
classifier=DecisionTreeClassifier(ccp_alpha=0.0, class_weight=None, criterion='gini',
                       max_depth=51, max_features=19, max_leaf_nodes=None,
...
results = cross_val_score(classifier, X_train, y_train,scoring='accuracy', cv=5)
