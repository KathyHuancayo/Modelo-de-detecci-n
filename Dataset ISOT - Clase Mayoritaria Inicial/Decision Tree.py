...
for depth in max_depth_range:
    ...
    clf = DecisionTreeClassifier(ccp_alpha=0.0, class_weight=None, criterion='gini',
                       max_depth=depth, max_features=20, max_leaf_nodes=None,
...
#CREAR EL MODELO
start = time.time()
model=DecisionTreeClassifier(ccp_alpha=0.0, class_weight='balanced', criterion='gini',
                       max_depth=35, max_features=20, max_leaf_nodes=None,
                       min_impurity_decrease=0.0, min_impurity_split=None,
...
#PINTAR EL ÁRBOL
out = StringIO()
tree.export_graphviz(model, out_file='treeMacarena.dot') 
